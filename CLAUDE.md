...
- 반응형: 320~1023px 유동 모바일 레이아웃(기준 뷰포트 390, 확인은 320/390/430), 1024px부터 좌측 패널 400px + 지도(**같은 컴포넌트, CSS로 자리만 바꾼다**). 상세·제보·내 활동은 패널 전환, 지도가 필요 없는 오버레이(로그인·리뷰 폼·사유·신고·탈퇴)만 중앙 모달 480px (decisions 2026-09-07).
