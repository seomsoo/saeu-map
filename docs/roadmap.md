...
- [ ] 얕은 /place/[id] 라우트 + 공유 딥링크 (SSR 메타·OG는 Phase 5 그대로 — decisions.md 2026-09-02)
- [ ] security-reviewer 에이전트 추가 (첫 쓰기 동작 도입 시점)
- 완료: design 화면 2(v2) 항목 전수 대조 + 버틸까 Figma 문법 비교로 차이 0(목업 기준 정정 2026-09-02), 다녀왔다면이 +1/롤백 동작, 갭 스윕 0건
